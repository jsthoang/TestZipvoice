...
PROMPT_WAV = "prompt_short2.wav"
PROMPT_TEXT = "đôi môi đầy đặn với đường nét gọn ghẽ như kẻ chỉ của nó mím lại, trông vừa hờn giận vừa trang nghiêm. Tôi cảm thấy trong Nếp có một điều gì tổn thương ghê gớm lắm nhưng chẳng biết làm gì để mà an ủi cả, bởi đối với tôi chuyện về bố Nếp"
LANG = "vi"
TOKENIZER = "espeak"
NUM_THREADS = 5
SPEED = 1.3
